...
class MyListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create my_list" do
    assert_difference('MyList.count') do
      post my_lists_url, params: { my_list: { anime_id: @my_list.anime_id, user_id: @my_list.user_id } }
    end
  ...
  test "should update my_list" do
    patch my_list_url(@my_list), params: { my_list: { anime_id: @my_list.anime_id, user_id: @my_list.user_id } }
