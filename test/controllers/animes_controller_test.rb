...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { day_in_week: @anime.day_in_week, episode: @anime.episode, name: @anime.name, on_air: @anime.on_air, show_time: @anime.show_time, synosis: @anime.synosis } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { day_in_week: @anime.day_in_week, episode: @anime.episode, name: @anime.name, on_air: @anime.on_air, show_time: @anime.show_time, synosis: @anime.synosis } }
