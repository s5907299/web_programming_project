...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { anime_id: @follow.anime_id, user_id: @follow.user_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { anime_id: @follow.anime_id, user_id: @follow.user_id } }
